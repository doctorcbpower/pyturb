...
class MexicanHatWavelet3D:
    """
    3D Mexican Hat wavelet analysis for turbulence fields.
    Based on Shi et al. (2018) - arXiv:1806.05056
    """
    
    def __init__(self, scales=None, n_scales=10):
        """
        Initialize 3D Mexican Hat wavelet analyzer.
